...
def create_parser():
    ...
    parser.add_argument('--fastmcp-host',
                       default=os.getenv('FASTMCP_HOST', '0.0.0.0'),
                       help='Host for FastMCP server (default: 0.0.0.0)')
    parser.add_argument('--fastmcp-port',
                       type=int,
                       default=int(os.getenv('FASTMCP_PORT', '8000')),
                       help='Port for FastMCP server (default: 8000)')
    
    # Chroma client options
...
def main():
    ...
    mcp.settings.host = args.fastmcp_host
    mcp.settings.port = args.fastmcp_port
